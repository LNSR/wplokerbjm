<template>
  <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-4">
    ...
    <div class="relative" ref="dropdownRef">
      ...
      ></div>
      <button
        class="btn btn-primary flex items-center gap-2 rounded-full !px-4 !py-3 cursor-pointer transform transition hover:scale-105 hover:!text-[var(--ast-global-color-1)] focus:ring-2 focus:ring-blue-400 !bg-[var(--ast-global-color-5)]"
      ...
      >
        ...
        >
          ...
          <div class="relative">
            <button
              @click="socialDropdownOpen = !socialDropdownOpen"
            ...
            >
              ...
              <svg
                class="w-4 h-4 ml-1 transition-transform"
                :class="{ 'rotate-180': socialDropdownOpen }"
                fill="none"
                stroke="currentColor"
                stroke-width="2"
                viewBox="0 0 24 24"
...
function handleScroll() {
  ...
  show.value = window.scrollY > halfPage
}
