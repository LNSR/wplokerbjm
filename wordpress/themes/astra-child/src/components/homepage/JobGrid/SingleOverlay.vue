    ...
    <aside v-if="visible"
      ...
      <div v-else-if="overlay" class="p-6 space-y-8 pt-16 flex-1 flex flex-col">
        ...
        <section v-if="overlay.tentangPerusahaan">
          ...
          <viewer v-html="overlay.tentangPerusahaan" @click="onWysiwygImgClick" />
          <div class="divider"></div>
        </section>
        ...
        <section v-if="overlay.deskripsiPekerjaan">
          ...
          <viewer v-html="overlay.deskripsiPekerjaan" @click="onWysiwygImgClick" />
          <div class="divider"></div>
        </section>
        ...
        <section v-if="overlay.persyaratan">
          ...
          <viewer v-html="overlay.persyaratan" @click="onWysiwygImgClick" />
          <div class="divider"></div>
        </section>
        ...
        <section v-if="overlay.caraMelamar">
          ...
          <viewer v-html="overlay.caraMelamar" @click="onWysiwygImgClick" />
          <div class="divider"></div>
        </section>
        ...
        <section v-if="overlay.benefit">
          ...
          <viewer v-html="overlay.benefit" @click="onWysiwygImgClick" />
          <div class="divider"></div>
        </section>
