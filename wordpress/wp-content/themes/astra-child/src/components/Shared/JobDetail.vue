<template>
  <div class="!space-y-8">
    ...
    <!-- Ringkasan Pekerjaan -->
    <section v-if="ringkasanPekerjaan && ringkasanPekerjaan.length">
    ...
    <!-- Kontak -->
    <section v-if="contacts && contacts.length">
    ...
    <!-- Sosial Media -->
    <section v-if="socialMediaItems && socialMediaItems.length">
      <h2 class="text-xl flex items-center gap-2 !mb-4">
...
const contacts = computed(() => useContactsJob(props.job.contacts))
