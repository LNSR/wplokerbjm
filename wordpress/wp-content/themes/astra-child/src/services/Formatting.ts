export class FormattingService {
   ...
   */
  static formatSalary(gaji_minimal?: number, gaji_maksimal?: number): string | null {
   ...
   * Format age range.
   */
  static formatAge(umur_min?: number, umur_max?: number): string | null {
  ...
  /** 
   * Format array or string to a comma-separated string.
   */
  static formatArray(value: string | string[] | null | undefined): string {
    if (!value) return '';
