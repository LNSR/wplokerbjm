...
- [**PostsCRUDListener**](../../../inc/Services/PostsManagement/SSG/PostsCRUDListener.php): Monitors post create/update/delete events for selective rebuilds
...
**Endpoint**: `/wp-json/astra-child/v1/dispatch-ssg/`  
**Method**: `POST`  
...
curl -X POST https://yoursite.com/wp-json/astra-child/v1/dispatch-ssg/ \
...
**Endpoint**: `/wp-json/astra-child/v1/`  
**Method**: `GET`  
**Authentication**: None required

```bash
# Check if endpoints are registered
curl https://yoursite.com/wp-json/astra-child/v1/
```
...
**Symptoms**: `/wp-json/astra-child/v1/dispatch-ssg/` returns 404
...
curl https://your-site.com/wp-json/astra-child/v1/
```
