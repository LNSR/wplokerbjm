...
class BotDetection {
	public function __construct(
		private \WPLokerBJM\Services\Utilities\SSG\BotDetectionHelper\BotRangeFetcher $botRangeFetcher,
		private \WPLokerBJM\Services\Utilities\SSG\BotDetectionHelper\DnsResolver $dnsResolver
	) {
	}
