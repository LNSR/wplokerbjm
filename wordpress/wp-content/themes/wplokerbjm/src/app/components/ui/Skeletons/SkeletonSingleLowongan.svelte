<main class="container mx-auto max-w-[90vw] lg:max-w-[60vw] space-y-8 mt-12">
  ...
  <section class="top-0">
    ...
    <div
      class="text-sm mt-2 flex items-center justify-center gap-2 animate-pulse"
    >
      ...
      >
        {#each Array(6)}
          <div class="flex items-center">
            ...
            <div class="flex-1">
              <div
                class="h-4 w-16 bg-gray-300 dark:bg-gray-600 rounded mb-1"
              ></div>
              <div class="h-4 w-24 bg-gray-300 dark:bg-gray-600 rounded"></div>
            </div>
          </div>
      ...
      >
        {#each Array(3)}
          <div class="flex items-center">
            ...
            <div class="flex-1">
              <div
                class="h-4 w-20 bg-gray-300 dark:bg-gray-600 rounded mb-1"
              ></div>
              <div class="h-4 w-32 bg-gray-300 dark:bg-gray-600 rounded"></div>
            </div>
          </div>
