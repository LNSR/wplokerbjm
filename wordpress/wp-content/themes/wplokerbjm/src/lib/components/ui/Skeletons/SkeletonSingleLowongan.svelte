...
<main class="container mx-auto max-w-[90vw] lg:max-w-[60vw] space-y-8 mt-12">
  ...
  <section
    class="overflow-hidden p-6 rounded-xl bg-[var(--wpl-global-color-5)] animate-pulse"
  >
        ...
        <div class="w-full flex flex-col">
          ...
          <div class="flex flex-col wrap-anywhere mb-4 mt-4">
            <div class="items-center gap-2 mb-2">
              <div
                class="w-5 h-5 bg-gray-300 dark:bg-gray-600 rounded inline-block"
              ></div>
              <div
                class="h-5 w-40 bg-gray-300 dark:bg-gray-600 rounded ml-2"
              ></div>
            </div>
            <div class="items-center gap-2 mb-2">
              <div
              ...
              ></div>
              <div
                class="h-5 w-32 bg-gray-300 dark:bg-gray-600 rounded ml-2"
              ></div>
            </div>
          </div>
        </div>
      ...
      >
        {#each Array(3) as _}
          <div class="flex items-start gap-2">
            ...
            <div class="w-full">
              <div
                class="h-4 bg-gray-300 dark:bg-gray-600 rounded w-1/2 mb-1"
              ></div>
      ...
      >
        {#each Array(6) as _}
          <div class="flex items-center">
            ...
            <div class="flex-1">
              <div
                class="h-4 w-24 bg-gray-300 dark:bg-gray-600 rounded mb-1"
              ></div>
