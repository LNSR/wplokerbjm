<?php
add_action('init', 'register_lowongan_taxonomies');
function register_lowongan_taxonomies()
{
    $labels = [
...
add_action('init', 'lokasi_pekerjaan');
function lokasi_pekerjaan()
{
    $labels = [
...
add_action('init', 'jenis_pekerjaan');
...
add_action('init', 'gender_taxonomy');
...
add_action('init', 'pendidikan_taxonomy');
function pendidikan_taxonomy()
{
    $labels = [
...
add_action('init', 'pengalaman_taxonomy');
function pengalaman_taxonomy()
{
    $labels = [
...
add_action('init', 'gaji_taxonomy');
function gaji_taxonomy()
{
    $labels = [
...
add_action('init', 'usia_taxonomy');
function usia_taxonomy()
{
    $labels = [
