    ...
    protected function renderPricingSection(): void
    {
        ...
        <section class="bg-white rounded-xl shadow-md p-4 sm:p-6 md:p-8 mb-12">
            ...
            <div class="py-12 px-4 text-center">
                <h3 class="text-4xl md:text-5xl font-bold text-blue-600 mb-2">Coming Soon</h3>
                <p class="text-gray-600 text-lg">Informasi paket pemasangan akan segera tersedia</p>
            </div>
