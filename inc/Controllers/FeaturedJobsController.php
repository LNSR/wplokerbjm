...
class FeaturedJobsController extends AjaxController
{
    ...
    public function handleRequest()
    {
        ...
        $per_page = isset($_POST['per_page']) ? intval($_POST['per_page']) : 10; // Default to 10
        
        // Pass the per_page parameter
        $featured_jobs = $this->jobModel->getFeaturedJobs($page, $filters, $per_page);
